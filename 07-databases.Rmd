...
Next, we can start a python file and import `mysql.connector`, and also `pandas` to be used later.
...
Likewise, SSH tunnels need to be closed when working remotely:
